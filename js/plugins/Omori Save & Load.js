...
Window_OmoriFileInformation.prototype.refresh = function() {
  ...
  if (valid) {
    ...
    this.contents.drawText(LanguageManager.getMessageData("XX_BLUE.Omori_Save_Load").level, loc_position[0] - 15, loc_position[1], 100, 24);
...
Window_OmoriFileCommand.prototype.initialize = function() {
  // Super Call
  Window_Command.prototype.initialize.call(this, 42 - 30, 28);
  // Setup File
...
Window_OmoriFileCommand.prototype.windowWidth = function () { return 149; };
