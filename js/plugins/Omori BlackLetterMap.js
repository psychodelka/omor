  ...
  bgBitmap.addLoadListener(() => {
    bgBitmap50.addLoadListener(() => {
      var mapData = [
        ...
        {name: 'POMARAŃCZOWA OAZA',     namePos: new Point(20, 55), rect: new Rectangle(545, 0, 122, 102), pos: new Point(31, 85),  blackSwitchId: 28, nameSwitchId: 35, blackSwitch50Id: 905 },
        {name: 'PLANETOWO INNE',  namePos: new Point(450, 75), rect: new Rectangle(419, 326, 140, 209), pos: new Point(390, 21),  blackSwitchId: 29, nameSwitchId: 36, blackSwitch50Id: 906 },
      ]
