...
//=============================================================================
// * Function that sorts the BlackLetterArray
// * Created originally by the Italian Localization Team
//=============================================================================
function sortBlackLetters(items){
...
Sprite_OmoBlackletter.prototype.setupBitmap = function() {
  ...
  if (this._letter === "") {
    // Set Bitmap
    this.bitmap = new Bitmap(26, 32);
    this.bitmap.fillRect(2, 30, 23, 2, 'rgba(255, 255, 255, 1)');
  } else {
    // Set Bitmap
